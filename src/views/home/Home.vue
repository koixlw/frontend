      ...
      <div class="banner-slider">
        <div class="banner-track" :style="bannerTrackStyle">
          <div class="banner-item">
            <img src="@/assets/images/content/battle.png" alt="泥彩人非遗文化" class="banner-img">
          ...
          <div class="banner-item">
            <img src="@/assets/images/content/image1.png" alt="泥彩人作品展示" class="banner-img">
            <div class="banner-content">
          ...
          <div class="banner-item">
            <img src="@/assets/images/content/chuanchengren.jpg" alt="泥彩人体验活动" class="banner-img">
            <div class="banner-content">
      ...
      <div class="container">
        ...
        <div class="about-content" v-scroll-reveal>
          ...
          <div class="about-image">
            <img src="@/assets/images/content/image1.png" alt="泥彩人历史" class="about-img">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="reserve-content" v-scroll-reveal>
          ...
          <div class="reserve-image">
            <img src="@/assets/images/content/xuanchuan.png" alt="泥彩人体验活动" class="reserve-img parallax-img">
          </div>
        </div>
      </div>
    </section>
...
// 按钮点击动画
const triggerButtonAnimation = (e) => {
...
.reserve-section {
  padding: 100px 0;
  position: relative;
  background-image: url('@/assets/images/content/image1.png');
